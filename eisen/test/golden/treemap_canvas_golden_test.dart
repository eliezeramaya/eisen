...
void main() {
  test('treemap layout small change has minimal area delta', () async {
    final tasks = <Task>[
      Task(
          id: 'a', title: 'A', quadrant: Quadrant.q1, priority: 6, minutes: 60),
      Task(
          id: 'b', title: 'B', quadrant: Quadrant.q1, priority: 5, minutes: 45),
      Task(
          id: 'c', title: 'C', quadrant: Quadrant.q2, priority: 4, minutes: 30),
      Task(
          id: 'd', title: 'D', quadrant: Quadrant.q3, priority: 7, minutes: 90),
    ];
    final cache = LayoutCache();
    final layout1 = computeStableLayout(tasks, cache: cache);
    // Small change in one task's minutes
    final tasks2 = tasks
        .map((t) => t.id == 'b' ? t.copyWith(minutes: t.minutes + 5) : t)
        .toList();
