...
void main() {
  group('Drag & Drop and Stack overlays', () {
    testWidgets('Dragging a tile into another quadrant triggers drop callback',
        (tester) async {
      final tasks = [
        Task(
            id: 'a',
      ...
      expect(
          hitTestLocal(
              ...
              tileCenter.translate(
                  ...
                  -tester.getTopLeft(find.byType(TreemapCanvas)).dy)),
          isNotNull);
    ...
    testWidgets('Stack overlay shows for tiny tiles and opens sheet on tap',
        (tester) async {
