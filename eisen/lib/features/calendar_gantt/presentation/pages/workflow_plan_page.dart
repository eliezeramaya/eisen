...
class _WorkflowPlanPageState extends ConsumerState<WorkflowPlanPage> {
  ...
  bool _needsDemoHint(List<CalendarSpan> spans) {
    ...
    final longCount = spans.where((s) => s.end.difference(s.start).inDays >= 7).length;
    return longCount < 4;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final dependencies = _useDemo ? const <TaskDependency>[] : ref.watch(dependencyArrowsProvider);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading:
            GoRouter.maybeOf(context) != null && context.canPop() ? BackButton(onPressed: () => context.pop()) : null,
      ),
                        ...
                        children: [
                          ...
                          if (showDemoToggle)
                            Row(
                              ...
                              children: [
                                Text(
                                  (Localizations.localeOf(context).languageCode == 'es') ? 'Ver demo' : 'Show demo',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (showDemoToggle) ...[
                              ...
                              TextButton.icon(
                                onPressed: () => setState(() => _useDemo = true),
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: GanttChart(
                        ...
                        onSpanTap: _useDemo ? null : (span) => _onSpanTap(tasksById, span),
